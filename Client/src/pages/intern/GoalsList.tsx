...
const STATUSES = ['All', 'Pending', 'In-Progress', 'Submitted', 'Approved', 'Revision-Required']
  ...
  return (
    <div className="page-container space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-secondary dark:text-white">My Goals</h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-secondary dark:text-white group-hover:text-primary-500 transition-colors">{goal.title}</p>
                      <p className="text-xs text-muted mt-0.5">Due {formatDate(goal.deadline)} • {goal.points} pts</p>
                    </div>
                  </div>
