  ...
  return (
    <div className="min-h-screen bg-background dark:bg-gray-950 flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-primaryText mb-3">Page not found</h1>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button onClick={() => window.history.back()} className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-border dark:border-gray-700 hover:shadow-hover text-primaryText font-semibold px-6 py-3 rounded-2xl transition-all">
