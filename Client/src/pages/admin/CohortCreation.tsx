...
const mockCohorts = [
  { _id: '1', name: 'Summer 2025 Batch', interns: 12, manager: 'Sarah Johnson', startDate: '2025-06-01', endDate: '2025-08-31' },
  { _id: '2', name: 'Winter 2025 Batch', interns: 8, manager: 'Mike Chen', startDate: '2025-01-10', endDate: '2025-03-31' },
]
...
export default function CohortCreation() {
  ...
  const handleCreate = () => {
    ...
    setCohorts(prev => [...prev, { _id: String(Date.now()), name: form.name, interns: 0, manager: 'Unassigned', startDate: form.startDate, endDate: form.endDate }])
